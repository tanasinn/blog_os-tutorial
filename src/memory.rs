...
use x86_64::structures::paging::{FrameAllocator, Mapper, Page, PageTable, PhysFrame, RecursivePageTable, Size4KiB};
...
pub unsafe fn init(level_4_table_addr: usize) -> RecursivePageTable<'static> {
    ...
    pub fn init_inner(level_4_table_addr: usize) -> RecursivePageTable<'static> {
